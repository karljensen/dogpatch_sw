...
const char* RISK_CODES[16] = { "TOKEN_AGE", "OPS", "ACTION_TYPE", "SHARE_QTY", "CACHE", "NOTIONAL", "AGE", "PRICE", "SPREAD", "CACHE_BETTER", "CACHE_EXPIRED", "CACHE_SIDE_INVERSION", "RISK_CONSUMED", "SIZE_ZERO", "LISTEN_TYPE", "CROSSED_MARKET"};
